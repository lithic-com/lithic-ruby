...
module Lithic
  ...
  module Converter
    ...
    class << self
      # @api private
      #
      # @param spec [Hash{Symbol=>Object}, Proc, Lithic::Converter, Class] .
      #
      ...
      def type_info(spec)
        ...
        in Proc
          spec
        in Lithic::Converter | Module | Symbol
          -> { spec }
        in true | false
          -> { Lithic::BooleanModel }
      ...
      #
      # @param target [Lithic::Converter, Class]
      # @param value [Object]
      #
      # @return [Object]
  ...
  class Unknown
    ...
    #
    # @return [Boolean]
    def self.==(other) = other.is_a?(Class) && other <= Lithic::Unknown
  ...
  module Enum
    ...
    # @return [Boolean]
    def ==(other)
      other.is_a?(Module) && other.singleton_class.ancestors.include?(Lithic::Enum) && other.values.to_set == values.to_set
    end
  ...
  module Union
    ...
    # @api private
    #
    # @param key [Symbol, Hash{Symbol=>Object}, Proc, Lithic::Converter, Class]
    #
    # @param spec [Hash{Symbol=>Object}, Proc, Lithic::Converter, Class] .
    #
    #   @option spec [NilClass, TrueClass, FalseClass, Integer, Float, Symbol] :const
    ...
    private def variant(key, spec = nil)
      variant_info =
        case key
        in Symbol
          [key, Lithic::Converter.type_info(spec)]
        in Proc | Lithic::Converter | Module | Hash
          [nil, Lithic::Converter.type_info(key)]
        end
    ...
    # @param value [Object]
    #
    # @return [Lithic::Converter, Class, nil]
    private def resolve_variant(value)
      case [@discriminator, value]
      in [_, Lithic::BaseModel]
        value.class
      in [Symbol, Hash]
        key =
        ...
        resolved.nil? ? Lithic::Unknown : resolved.call
      else
        nil
      end
    end
    ...
    # @return [Boolean]
    def ==(other)
      other.is_a?(Module) && other.singleton_class.ancestors.include?(Lithic::Union) && other.derefed_variants == derefed_variants
    end
    ...
    def coerce(value)
      if (variant = resolve_variant(value))
        return Lithic::Converter.coerce(variant, value)
      end
      ...
      known_variants.each do |_, variant_fn|
        ...
        case Lithic::Converter.try_strict_coerce(variant, value)
        in [true, coerced, _]
          return coerced
        in [false, true, score]
      ...
      variant.nil? ? value : Lithic::Converter.coerce(variant, value)
    end
    ...
    def dump(value)
      if (variant = resolve_variant(value))
        return Lithic::Converter.dump(variant, value)
      end
  ...
  class ArrayOf
    ...
    # @param type_info [Hash{Symbol=>Object}, Proc, Lithic::Converter, Class]
    #
    ...
    #
    # @return [Boolean]
    def ==(other) = other.is_a?(Lithic::ArrayOf) && other.item_type == item_type
    ...
    def coerce(value)
      ...
      in Enumerable unless value.is_a?(Hash)
        value.map { Lithic::Converter.coerce(type, _1) }
      else
        value
      end
    end
    ...
    def dump(value)
      ...
      case value
      in Enumerable unless value.is_a?(Hash)
        value.map { Lithic::Converter.dump(type, _1) }.to_a
      else
        value
      end
    end
    ...
    def try_strict_coerce(value)
      ...
      in Array
        ...
        mapped =
          value.map do |item|
            case Lithic::Converter.try_strict_coerce(type, item)
            in [true, coerced, score]
              tally += score
              coerced
            in [false, true, score]
    ...
    def initialize(type_info, spec = {})
      @item_type_fn = Lithic::Converter.type_info(type_info || spec)
    end
  end
  ...
  class HashOf
    ...
    #
    # @return [Boolean]
    def ==(other) = other.is_a?(Lithic::HashOf) && other.item_type == item_type
    ...
    def coerce(value)
      ...
      in Hash
        value.to_h do |key, val|
          coerced = Lithic::Converter.coerce(type, val)
    ...
    def dump(value)
      ...
      in Hash
        value.transform_values do |val|
          Lithic::Converter.dump(type, val)
        end
      else
        value
      end
    ...
    def try_strict_coerce(value)
      ...
      in Hash
        ...
        mapped =
          value.transform_values do |val|
            case Lithic::Converter.try_strict_coerce(type, val)
            in [true, coerced, score]
              tally += score
              coerced
            in [false, true, score]
  ...
  class BaseModel
    ...
    class << self
      ...
      def reverse_map
        @reverse_map ||= (self < Lithic::BaseModel ? superclass.reverse_map.dup : {})
      end
      ...
      private def add_field(name_sym, required:, type_info:, spec:)
        type_fn, info =
          case type_info
          in Proc | Module | Lithic::Converter
            [Lithic::Converter.type_info({**spec, union: type_info}), spec]
          in Hash
            [Lithic::Converter.type_info(type_info), type_info]
          end
        ...
        define_method(name_sym) do
          ...
          Lithic::Converter.coerce(field_type, value)
        rescue StandardError
          name = self.class.name.split("::").last
          raise Lithic::ConversionError.new(
    ...
    class << self
      ...
      def coerce(value)
        case Lithic::Util.coerce_hash(value)
        in Hash => coerced
          new(coerced)
        else
          value
      ...
      def dump(value)
        unless (coerced = Lithic::Util.coerce_hash(value)).is_a?(Hash)
          return value
        end
        ...
        values = coerced.filter_map do |key, val|
          ...
          in nil
            ...
            in :coerce
              ...
              target = type_fn.call
              [api_name, Lithic::Converter.dump(target, val)]
            end
          end
        end.to_h
      ...
      def try_strict_coerce(value)
        ...
        known_fields.each_value do |field|
          ...
          in [_, true]
            ...
            case Lithic::Converter.try_strict_coerce(target, item)
            in [true, coerced, score]
              tally += score
    ...
    def initialize(data = {})
      case Lithic::Util.coerce_hash(data)
      in Hash => coerced
        @data = coerced.to_h do |key, value|
          ...
          stored =
            case [type, value]
            in [Module, Hash] if type <= Lithic::BaseModel
              type.new(value)
            in [Lithic::ArrayOf, Array] | [Lithic::HashOf, Hash]
              type.coerce(value)
            else
              value
            end

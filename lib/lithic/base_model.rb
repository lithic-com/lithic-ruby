...
module Lithic
  ...
  module Converter
    ...
    class << self
      ...
      def type_info(spec)
        ...
        in true | false
          -> { Lithic::BooleanModel }
        in Lithic::Converter | Class | Symbol
          -> { spec }
      ...
      def dump(target, value)
        target.is_a?(Lithic::Converter) ? target.dump(value) : Lithic::Unknown.dump(value)
      end
    end
  end
  ...
  module Enum
    ...
    # @return [Boolean]
    def ==(other)
      other.is_a?(Module) && other.singleton_class <= Lithic::Enum && other.values.to_set == values.to_set
    end
  ...
  module Union
    ...
    private def variant(key, spec = nil)
      variant_info =
        ...
        in Proc | Lithic::Converter | Class | Hash
    ...
    private def resolve_variant(value)
      ...
      in [Symbol, Hash]
        key = value.fetch(@discriminator) do
          value.fetch(@discriminator.to_s, Lithic::Util::OMIT)
        end

        return nil if key == Lithic::Util::OMIT
    ...
    def coerce(value, state:)
      if (target = resolve_variant(value))
        return Lithic::Converter.coerce(target, value, state: state)
      end
      ...
      known_variants.each do |_, variant_fn|
        ...
        coerced = Lithic::Converter.coerce(target, value, state: state)
    ...
    def dump(value)
      if (target = resolve_variant(value))
        return Lithic::Converter.dump(target, value)
      end

      known_variants.each do
        target = _2.call
        return Lithic::Converter.dump(target, value) if target === value
      end
  ...
  class ArrayOf
      ...
      value
        .map do |item|
          ...
          in [true, nil]
            ...
            Lithic::Converter.coerce(target, item, state: state)
          end
        end
    end
    ...
    def dump(value)
      target = item_type
      value.is_a?(Array) ? value.map { Lithic::Converter.dump(target, _1) } : super
    end
  ...
  class HashOf
        ...
        .to_h do |key, val|
          ...
          v =
            ...
            in [true, nil]
              ...
              Lithic::Converter.coerce(target, val, state: state)
            end
    ...
    def dump(value)
      target = item_type
      value.is_a?(Hash) ? value.transform_values { Lithic::Converter.dump(target, _1) } : super
    end
  ...
  class BaseModel
    ...
    class << self
      ...
      private def add_field(name_sym, required:, type_info:, spec:)
        type_fn, info =
          case type_info
          in Proc | Lithic::Converter | Class
        ...
        nilable = info[:nil?]
        const = required && !nilable ? info.fetch(:const, Lithic::Util::OMIT) : Lithic::Util::OMIT
        ...
        define_method(name_sym) do
          target = type_fn.call
          value = @data.fetch(name_sym) { const == Lithic::Util::OMIT ? nil : const }
          state = {strictness: :strong, exactness: {yes: 0, no: 0, maybe: 0}, branched: 0}
          (nilable || !required) && value.nil? ? nil : Lithic::Converter.coerce(target, value, state: state)
    ...
    class << self
      ...
      def coerce(value, state:)
        ...
        unless (val = Lithic::Util.coerce_hash(value)).is_a?(Hash)
          exactness[:no] += 1
          return value
        end
        exactness[:yes] += 1
        ...
        fields.each do |name, field|
          ...
          converted =
            if item.nil? && (nilable || !required)
              ...
              coerced = Lithic::Converter.coerce(target, item, state: state)
              case target
              in Lithic::Converter | Symbol
                coerced
              else
                item
              end
      ...
      def dump(value)
        ...
        coerced.each do |key, val|
          ...
          in nil
            ...
            in :coerce
              ...
              target = type_fn.call
              acc.store(api_name, Lithic::Converter.dump(target, val))
            end
          end
        end
        ...
        known_fields.each_value do |field|
          ...
          next if mode == :coerce || acc.key?(api_name) || const == Lithic::Util::OMIT

  ...
  module Internal
    module Transport
      ...
      class BaseClient
        ...
        PLATFORM_HEADERS =
          {
            "x-stainless-arch" => Lithic::Internal::Util.arch,
            "x-stainless-lang" => "ruby",
            "x-stainless-os" => Lithic::Internal::Util.os,
        ...
        class << self
          ...
          def should_retry?(status, headers:)
            coerced = Lithic::Internal::Util.coerce_boolean(headers["x-should-retry"])
            case [coerced, status]
            in [true | false, _]
              coerced
          ...
          def follow_redirect(request, status:, response_headers:)
            ...
            # from undici
            if Lithic::Internal::Util.uri_origin(url) != Lithic::Internal::Util.uri_origin(location)
        ...
        def initialize(
          ...
          @requester = Lithic::Internal::Transport::PooledNetRequester.new
          @headers = Lithic::Internal::Util.normalized_headers(
          ...
          @base_url = Lithic::Internal::Util.parse_uri(base_url)
        ...
        private def build_request(req, opts)
          ...
          path = Lithic::Internal::Util.interpolate_path(uninterpolated_path)

          query = Lithic::Internal::Util.deep_merge(req[:query].to_h, opts[:extra_query].to_h)
          ...
          {
            method: method,
            url: Lithic::Internal::Util.join_parsed_uri(@base_url, {**req, path: path, query: query}),
            headers: headers,
            body: encoded,
        ...
        def inspect
          ...
          base_url = Lithic::Internal::Util.unparse_uri(@base_url)

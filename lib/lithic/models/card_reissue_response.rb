...
module Lithic
  module Models
    ...
    class CardReissueResponse < Lithic::Internal::Type::BaseModel
      ...
      #
      #   @return [Lithic::Models::CardReissueResponse::Funding]
      required :funding, -> { Lithic::Models::CardReissueResponse::Funding }
      ...
      #   attempts).
      #
      #   @return [Symbol, Lithic::Models::CardReissueResponse::PinStatus]
      required :pin_status, enum: -> { Lithic::Models::CardReissueResponse::PinStatus }
      ...
      #
      #   @return [Symbol, Lithic::Models::CardReissueResponse::SpendLimitDuration]
      required :spend_limit_duration, enum: -> { Lithic::Models::CardReissueResponse::SpendLimitDuration }
      ...
      #   manufactured.
      #
      #   @return [Symbol, Lithic::Models::CardReissueResponse::State]
      required :state, enum: -> { Lithic::Models::CardReissueResponse::State }
      ...
      #   VIRTUAL instead.
      #
      #   @return [Symbol, Lithic::Models::CardReissueResponse::Type]
      required :type, enum: -> { Lithic::Models::CardReissueResponse::Type }
      ...
      #   @param created [Time]
      #   @param funding [Lithic::Models::CardReissueResponse::Funding]
      #   @param last_four [String]
      #   @param pin_status [Symbol, Lithic::Models::CardReissueResponse::PinStatus]
      #   @param spend_limit [Integer]
      #   @param spend_limit_duration [Symbol, Lithic::Models::CardReissueResponse::SpendLimitDuration]
      #   @param state [Symbol, Lithic::Models::CardReissueResponse::State]
      #   @param type [Symbol, Lithic::Models::CardReissueResponse::Type]
      ...
      # @see Lithic::Models::CardReissueResponse#funding
      class Funding < Lithic::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Lithic::Models::CardReissueResponse::Funding::State]
        required :state, enum: -> { Lithic::Models::CardReissueResponse::Funding::State }

        # @!attribute type
        #   Types of funding source: _ `DEPOSITORY_CHECKING` - Bank checking account. _
        #   `DEPOSITORY_SAVINGS` - Bank savings account.
        #
        #   @return [Symbol, Lithic::Models::CardReissueResponse::Funding::Type]
        required :type, enum: -> { Lithic::Models::CardReissueResponse::Funding::Type }
        ...
        #   @param created [Time]
        #   @param last_four [String]
        #   @param state [Symbol, Lithic::Models::CardReissueResponse::Funding::State]
        #   @param type [Symbol, Lithic::Models::CardReissueResponse::Funding::Type]
        ...
        # verification. \* `DELETED` - The founding account has been deleted.
        #
        # @see Lithic::Models::CardReissueResponse::Funding#state
        module State
        ...
        # `DEPOSITORY_SAVINGS` - Bank savings account.
        #
        # @see Lithic::Models::CardReissueResponse::Funding#type
        module Type
          extend Lithic::Internal::Type::Enum
      ...
      # attempts).
      #
      # @see Lithic::Models::CardReissueResponse#pin_status
      module PinStatus
        extend Lithic::Internal::Type::Enum
      ...
      # Spend limit duration
      #
      # @see Lithic::Models::CardReissueResponse#spend_limit_duration
      ...
      # manufactured.
      #
      # @see Lithic::Models::CardReissueResponse#state
      module State
        extend Lithic::Internal::Type::Enum
      ...
      # VIRTUAL instead.
      #
      # @see Lithic::Models::CardReissueResponse#type
      module Type
        extend Lithic::Internal::Type::Enum

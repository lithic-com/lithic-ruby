  ...
  module Models
    module ExternalBankAccounts
      ...
      class MicroDepositCreateResponse < Lithic::Internal::Type::BaseModel
        ...
        #   Owner Type
        #
        #   @return [Symbol, Lithic::Models::ExternalBankAccounts::MicroDepositCreateResponse::OwnerType]
        required :owner_type,
                 enum: -> { Lithic::Models::ExternalBankAccounts::MicroDepositCreateResponse::OwnerType }
        ...
        #   Account State
        #
        #   @return [Symbol, Lithic::Models::ExternalBankAccounts::MicroDepositCreateResponse::State]
        required :state, enum: -> { Lithic::Models::ExternalBankAccounts::MicroDepositCreateResponse::State }

        # @!attribute type
        #   Account Type
        #
        #   @return [Symbol, Lithic::Models::ExternalBankAccounts::MicroDepositCreateResponse::Type]
        required :type, enum: -> { Lithic::Models::ExternalBankAccounts::MicroDepositCreateResponse::Type }
        ...
        #   Verification Method
        #
        #   @return [Symbol, Lithic::Models::ExternalBankAccounts::MicroDepositCreateResponse::VerificationMethod]
        required :verification_method,
                 enum: -> { Lithic::Models::ExternalBankAccounts::MicroDepositCreateResponse::VerificationMethod }

        # @!attribute verification_state
        #   Verification State
        #
        #   @return [Symbol, Lithic::Models::ExternalBankAccounts::MicroDepositCreateResponse::VerificationState]
        required :verification_state,
                 enum: -> { Lithic::Models::ExternalBankAccounts::MicroDepositCreateResponse::VerificationState }
        ...
        #   {Lithic::Models::ExternalBankAccounts::MicroDepositCreateResponse} for more
        #   details.
        #
        ...
        #
        #   @param owner_type [Symbol, Lithic::Models::ExternalBankAccounts::MicroDepositCreateResponse::OwnerType] Owner Type
        #
        #   @param routing_number [String] Routing Number
        #
        #   @param state [Symbol, Lithic::Models::ExternalBankAccounts::MicroDepositCreateResponse::State] Account State
        #
        #   @param type [Symbol, Lithic::Models::ExternalBankAccounts::MicroDepositCreateResponse::Type] Account Type
        #
        #   @param verification_attempts [Integer] The number of attempts at verification
        #
        #   @param verification_method [Symbol, Lithic::Models::ExternalBankAccounts::MicroDepositCreateResponse::VerificationMethod] Verification Method
        #
        #   @param verification_state [Symbol, Lithic::Models::ExternalBankAccounts::MicroDepositCreateResponse::VerificationState] Verification State
        #

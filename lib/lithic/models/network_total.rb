...
module Lithic
  module Models
    class NetworkTotal < Lithic::Internal::Type::BaseModel
      ...
      # @!attribute amounts
      #
      #   @return [Lithic::Models::NetworkTotal::Amounts]
      ...
      #   or INTERLINK.
      #
      #   @return [Symbol, Lithic::Models::NetworkTotal::Network]
      ...
      #   {Lithic::Models::NetworkTotal} for more details.
      #
      #   @param token [String] Globally unique identifier.
      #
      #   @param amounts [Lithic::Models::NetworkTotal::Amounts]
      #
      ...
      #
      #   @param network [Symbol, Lithic::Models::NetworkTotal::Network] Card network where the transaction took place. AMEX, VISA, MASTERCARD, MAESTRO,
      #
      ...
      # @see Lithic::Models::NetworkTotal#amounts
      class Amounts < Lithic::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {Lithic::Models::NetworkTotal::Amounts} for more details.
        #
      ...
      # or INTERLINK.
      #
      # @see Lithic::Models::NetworkTotal#network
      module Network

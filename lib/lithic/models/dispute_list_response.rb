...
module Lithic
  module Models
    ...
    class DisputeListResponse < Lithic::Internal::Type::BaseModel
      ...
      #     cancelled.
      #
      #   @return [Symbol, Lithic::Models::DisputeListResponse::Reason]
      required :reason, enum: -> { Lithic::Models::DisputeListResponse::Reason }
      ...
      #
      #   @return [Symbol, Lithic::Models::DisputeListResponse::ResolutionReason, nil]
      required :resolution_reason,
               enum: -> { Lithic::Models::DisputeListResponse::ResolutionReason },
               nil?: true
      ...
      #
      #   @return [Symbol, Lithic::Models::DisputeListResponse::Status]
      required :status, enum: -> { Lithic::Models::DisputeListResponse::Status }
      ...
      #   {Lithic::Models::DisputeListResponse} for more details.
      #
      #   Dispute.
      #
      ...
      #
      #   @param reason [Symbol, Lithic::Models::DisputeListResponse::Reason] Dispute reason:
      #
      ...
      #
      #   @param resolution_reason [Symbol, Lithic::Models::DisputeListResponse::ResolutionReason, nil] Reason for the dispute resolution:
      #
      #   @param status [Symbol, Lithic::Models::DisputeListResponse::Status] Status types:
      #
      ...
      #   cancelled.
      #
      # @see Lithic::Models::DisputeListResponse#reason
      module Reason
      ...
      # - `WON_PREARBITRATION`: Won prearbitration.
      #
      # @see Lithic::Models::DisputeListResponse#resolution_reason
      ...
      # - `CASE_CLOSED` - Case was lost or withdrawn.
      #
      # @see Lithic::Models::DisputeListResponse#status
      module Status
        extend Lithic::Internal::Type::Enum

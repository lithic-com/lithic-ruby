...
module Lithic
  module Models
    ...
    class CardRetrieveResponse < Lithic::Internal::Type::BaseModel
      ...
      #
      #   @return [Lithic::Models::CardRetrieveResponse::Funding]
      required :funding, -> { Lithic::Models::CardRetrieveResponse::Funding }
      ...
      #   attempts).
      #
      #   @return [Symbol, Lithic::Models::CardRetrieveResponse::PinStatus]
      required :pin_status, enum: -> { Lithic::Models::CardRetrieveResponse::PinStatus }
      ...
      #
      #   @return [Symbol, Lithic::Models::CardRetrieveResponse::SpendLimitDuration]
      required :spend_limit_duration, enum: -> { Lithic::Models::CardRetrieveResponse::SpendLimitDuration }
      ...
      #   manufactured.
      #
      #   @return [Symbol, Lithic::Models::CardRetrieveResponse::State]
      required :state, enum: -> { Lithic::Models::CardRetrieveResponse::State }
      ...
      #   VIRTUAL instead.
      #
      #   @return [Symbol, Lithic::Models::CardRetrieveResponse::Type]
      ...
      #   @param created [Time]
      #   @param funding [Lithic::Models::CardRetrieveResponse::Funding]
      #   @param last_four [String]
      #   @param pin_status [Symbol, Lithic::Models::CardRetrieveResponse::PinStatus]
      #   @param spend_limit [Integer]
      #   @param spend_limit_duration [Symbol, Lithic::Models::CardRetrieveResponse::SpendLimitDuration]
      #   @param state [Symbol, Lithic::Models::CardRetrieveResponse::State]
      #   @param type [Symbol, Lithic::Models::CardRetrieveResponse::Type]
      ...
      # @see Lithic::Models::CardRetrieveResponse#funding
      class Funding < Lithic::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Lithic::Models::CardRetrieveResponse::Funding::State]
        required :state, enum: -> { Lithic::Models::CardRetrieveResponse::Funding::State }

        # @!attribute type
        #   Types of funding source: _ `DEPOSITORY_CHECKING` - Bank checking account. _
        #   `DEPOSITORY_SAVINGS` - Bank savings account.
        #
        #   @return [Symbol, Lithic::Models::CardRetrieveResponse::Funding::Type]
        required :type, enum: -> { Lithic::Models::CardRetrieveResponse::Funding::Type }
        ...
        #   @param created [Time]
        #   @param last_four [String]
        #   @param state [Symbol, Lithic::Models::CardRetrieveResponse::Funding::State]
        #   @param type [Symbol, Lithic::Models::CardRetrieveResponse::Funding::Type]
        ...
        # verification. \* `DELETED` - The founding account has been deleted.
        #
        # @see Lithic::Models::CardRetrieveResponse::Funding#state
        module State
        ...
        # `DEPOSITORY_SAVINGS` - Bank savings account.
        #
        # @see Lithic::Models::CardRetrieveResponse::Funding#type
        module Type
          extend Lithic::Internal::Type::Enum
      ...
      # attempts).
      #
      # @see Lithic::Models::CardRetrieveResponse#pin_status
      module PinStatus
        extend Lithic::Internal::Type::Enum
      ...
      # Spend limit duration
      #
      # @see Lithic::Models::CardRetrieveResponse#spend_limit_duration
      ...
      # manufactured.
      #
      # @see Lithic::Models::CardRetrieveResponse#state
      module State
        extend Lithic::Internal::Type::Enum
      ...
      # VIRTUAL instead.
      #
      # @see Lithic::Models::CardRetrieveResponse#type
      module Type
        extend Lithic::Internal::Type::Enum

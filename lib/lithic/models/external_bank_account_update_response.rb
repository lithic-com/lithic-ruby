...
module Lithic
  module Models
    class ExternalBankAccountUpdateResponse < Lithic::BaseModel
      ...
      #   Owner Type
      #
      #   @return [Symbol, Lithic::Models::ExternalBankAccountUpdateResponse::OwnerType]
      ...
      #   Account State
      #
      #   @return [Symbol, Lithic::Models::ExternalBankAccountUpdateResponse::State]
      required :state, enum: -> { Lithic::Models::ExternalBankAccountUpdateResponse::State }

      # @!attribute type
      #   Account Type
      #
      #   @return [Symbol, Lithic::Models::ExternalBankAccountUpdateResponse::Type]
      ...
      #   Verification Method
      #
      #   @return [Symbol, Lithic::Models::ExternalBankAccountUpdateResponse::VerificationMethod]
      ...
      #   Verification State
      #
      #   @return [Symbol, Lithic::Models::ExternalBankAccountUpdateResponse::VerificationState]

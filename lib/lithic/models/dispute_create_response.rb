...
module Lithic
  module Models
    ...
    class DisputeCreateResponse < Lithic::Internal::Type::BaseModel
      # @!attribute token
      ...
      #     cancelled.
      #
      #   @return [Symbol, Lithic::Models::DisputeCreateResponse::Reason]
      required :reason, enum: -> { Lithic::Models::DisputeCreateResponse::Reason }
      ...
      #
      #   @return [Symbol, Lithic::Models::DisputeCreateResponse::ResolutionReason, nil]
      required :resolution_reason,
               enum: -> { Lithic::Models::DisputeCreateResponse::ResolutionReason },
               nil?: true
      ...
      #
      #   @return [Symbol, Lithic::Models::DisputeCreateResponse::Status]
      required :status, enum: -> { Lithic::Models::DisputeCreateResponse::Status }
      ...
      #   {Lithic::Models::DisputeCreateResponse} for more details.
      #
      #   Dispute.
      #
      ...
      #
      #   @param reason [Symbol, Lithic::Models::DisputeCreateResponse::Reason] Dispute reason:
      #
      ...
      #
      #   @param resolution_reason [Symbol, Lithic::Models::DisputeCreateResponse::ResolutionReason, nil] Reason for the dispute resolution:
      #
      #   @param status [Symbol, Lithic::Models::DisputeCreateResponse::Status] Status types:
      #
      ...
      #   cancelled.
      #
      # @see Lithic::Models::DisputeCreateResponse#reason
      module Reason
      ...
      # - `WON_PREARBITRATION`: Won prearbitration.
      #
      # @see Lithic::Models::DisputeCreateResponse#resolution_reason
      ...
      # - `CASE_CLOSED` - Case was lost or withdrawn.
      #
      # @see Lithic::Models::DisputeCreateResponse#status
      module Status
        extend Lithic::Internal::Type::Enum

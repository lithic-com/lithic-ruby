...
module Lithic
  module Models
    ...
    class ExternalBankAccountRetrieveResponse < Lithic::Internal::Type::BaseModel
      ...
      #   Owner Type
      #
      #   @return [Symbol, Lithic::Models::ExternalBankAccountRetrieveResponse::OwnerType]
      required :owner_type, enum: -> { Lithic::Models::ExternalBankAccountRetrieveResponse::OwnerType }
      ...
      #   Account State
      #
      #   @return [Symbol, Lithic::Models::ExternalBankAccountRetrieveResponse::State]
      required :state, enum: -> { Lithic::Models::ExternalBankAccountRetrieveResponse::State }

      # @!attribute type
      #   Account Type
      #
      #   @return [Symbol, Lithic::Models::ExternalBankAccountRetrieveResponse::Type]
      required :type, enum: -> { Lithic::Models::ExternalBankAccountRetrieveResponse::Type }
      ...
      #   Verification Method
      #
      #   @return [Symbol, Lithic::Models::ExternalBankAccountRetrieveResponse::VerificationMethod]
      required :verification_method,
               enum: -> { Lithic::Models::ExternalBankAccountRetrieveResponse::VerificationMethod }

      # @!attribute verification_state
      #   Verification State
      #
      #   @return [Symbol, Lithic::Models::ExternalBankAccountRetrieveResponse::VerificationState]
      required :verification_state,
               enum: -> { Lithic::Models::ExternalBankAccountRetrieveResponse::VerificationState }
      ...
      # Owner Type
      #
      # @see Lithic::Models::ExternalBankAccountRetrieveResponse#owner_type
      module OwnerType
      ...
      # Account State
      #
      # @see Lithic::Models::ExternalBankAccountRetrieveResponse#state
      module State
        extend Lithic::Internal::Type::Enum
      ...
      # Account Type
      #
      # @see Lithic::Models::ExternalBankAccountRetrieveResponse#type
      module Type
        extend Lithic::Internal::Type::Enum
      ...
      # Verification Method
      #
      # @see Lithic::Models::ExternalBankAccountRetrieveResponse#verification_method
      ...
      # Verification State
      #
      # @see Lithic::Models::ExternalBankAccountRetrieveResponse#verification_state

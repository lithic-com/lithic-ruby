...
module Lithic
  module Models
    ...
    class DisputeDeleteResponse < Lithic::Internal::Type::BaseModel
      ...
      #     cancelled.
      #
      #   @return [Symbol, Lithic::Models::DisputeDeleteResponse::Reason]
      required :reason, enum: -> { Lithic::Models::DisputeDeleteResponse::Reason }
      ...
      #
      #   @return [Symbol, Lithic::Models::DisputeDeleteResponse::ResolutionReason, nil]
      required :resolution_reason,
               enum: -> { Lithic::Models::DisputeDeleteResponse::ResolutionReason },
               nil?: true
      ...
      #
      #   @return [Symbol, Lithic::Models::DisputeDeleteResponse::Status]
      required :status, enum: -> { Lithic::Models::DisputeDeleteResponse::Status }
      ...
      #   {Lithic::Models::DisputeDeleteResponse} for more details.
      #
      #   Dispute.
      #
      ...
      #
      #   @param reason [Symbol, Lithic::Models::DisputeDeleteResponse::Reason] Dispute reason:
      #
      ...
      #
      #   @param resolution_reason [Symbol, Lithic::Models::DisputeDeleteResponse::ResolutionReason, nil] Reason for the dispute resolution:
      #
      #   @param status [Symbol, Lithic::Models::DisputeDeleteResponse::Status] Status types:
      #
      ...
      #   cancelled.
      #
      # @see Lithic::Models::DisputeDeleteResponse#reason
      module Reason
      ...
      # - `WON_PREARBITRATION`: Won prearbitration.
      #
      # @see Lithic::Models::DisputeDeleteResponse#resolution_reason
      ...
      # - `CASE_CLOSED` - Case was lost or withdrawn.
      #
      # @see Lithic::Models::DisputeDeleteResponse#status
      module Status
        extend Lithic::Internal::Type::Enum

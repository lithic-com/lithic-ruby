  ...
  module Models
    module AuthRules
      ...
      class V2UpdateResponse < Lithic::Internal::Type::BaseModel
        ...
        #
        #   @param event_stream [Symbol, Lithic::Models::AuthRules::V2UpdateResponse::EventStream] The type of event stream the Auth rule applies to.
        #
        ...
        #
        #   @param type [Symbol, Lithic::Models::AuthRules::V2UpdateResponse::Type] The type of Auth Rule. Effectively determines the event stream during which it w
        #

    ...
    module AuthRules
      ...
      class V2DraftParams < Lithic::Internal::Type::BaseModel
        ...
        module Parameters
          ...
          variant -> { Lithic::Models::AuthRules::V2DraftParams::Parameters::MerchantLockParameters }
          ...
          class MerchantLockParameters < Lithic::Internal::Type::BaseModel
            ...
            required :merchants,
                     -> { Lithic::Internal::Type::ArrayOf[Lithic::Models::AuthRules::V2DraftParams::Parameters::MerchantLockParameters::Merchant] }

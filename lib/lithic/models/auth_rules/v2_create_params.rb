  ...
  module Models
    module AuthRules
      ...
      class V2CreateParams < Lithic::Internal::Type::BaseModel
        ...
        # @!attribute body
        #
        #   @return [Lithic::Models::AuthRules::V2CreateParams::Body::AccountLevelRule, Lithic::Models::AuthRules::V2CreateParams::Body::CardLevelRule, Lithic::Models::AuthRules::V2CreateParams::Body::ProgramLevelRule]
        required :body, union: -> { Lithic::AuthRules::V2CreateParams::Body }

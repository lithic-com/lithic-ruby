...
module Lithic
  module Models
    class ExternalBankAccountRetryPrenoteResponse < Lithic::BaseModel
      ...
      #   Account State
      #
      #   @return [Symbol, Lithic::Models::ExternalBankAccountRetryPrenoteResponse::State]
      required :state, enum: -> { Lithic::Models::ExternalBankAccountRetryPrenoteResponse::State }

      # @!attribute type
      #   Account Type
      #
      #   @return [Symbol, Lithic::Models::ExternalBankAccountRetryPrenoteResponse::Type]
      required :type, enum: -> { Lithic::Models::ExternalBankAccountRetryPrenoteResponse::Type }
      ...
      #   Verification State
      #
      #   @return [Symbol, Lithic::Models::ExternalBankAccountRetryPrenoteResponse::VerificationState]
      required :verification_state,
               enum: -> { Lithic::Models::ExternalBankAccountRetryPrenoteResponse::VerificationState }

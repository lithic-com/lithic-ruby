...
module Lithic
  module Models
    ...
    class ExternalBankAccount < Lithic::Internal::Type::BaseModel
      ...
      #   Account State
      #
      #   @return [Symbol, Lithic::Models::ExternalBankAccount::State]
      required :state, enum: -> { Lithic::ExternalBankAccount::State }

      # @!attribute type
      #   Account Type
      #
      #   @return [Symbol, Lithic::Models::ExternalBankAccount::Type]
      ...
      #   Verification State
      #
      #   @return [Symbol, Lithic::Models::ExternalBankAccount::VerificationState]
      ...
      #
      #   @param state [Symbol, Lithic::Models::ExternalBankAccount::State] Account State
      #
      #   @param type [Symbol, Lithic::Models::ExternalBankAccount::Type] Account Type
      #
      ...
      #
      #   @param verification_state [Symbol, Lithic::Models::ExternalBankAccount::VerificationState] Verification State
      #
      ...
      # Account State
      #
      # @see Lithic::Models::ExternalBankAccount#state
      module State
      ...
      # Account Type
      #
      # @see Lithic::Models::ExternalBankAccount#type
      module Type
        extend Lithic::Internal::Type::Enum
      ...
      # Verification State
      #
      # @see Lithic::Models::ExternalBankAccount#verification_state

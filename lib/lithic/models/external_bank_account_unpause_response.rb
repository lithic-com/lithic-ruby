...
module Lithic
  module Models
    # @see Lithic::Resources::ExternalBankAccounts#unpause
    class ExternalBankAccountUnpauseResponse < Lithic::Internal::Type::BaseModel
      ...
      #   Account State
      #
      #   @return [Symbol, Lithic::Models::ExternalBankAccountUnpauseResponse::State]
      required :state, enum: -> { Lithic::Models::ExternalBankAccountUnpauseResponse::State }

      # @!attribute type
      #   Account Type
      #
      #   @return [Symbol, Lithic::Models::ExternalBankAccountUnpauseResponse::Type]
      required :type, enum: -> { Lithic::Models::ExternalBankAccountUnpauseResponse::Type }
      ...
      #   Verification State
      #
      #   @return [Symbol, Lithic::Models::ExternalBankAccountUnpauseResponse::VerificationState]
      required :verification_state,
               enum: -> { Lithic::Models::ExternalBankAccountUnpauseResponse::VerificationState }
      ...
      #   {Lithic::Models::ExternalBankAccountUnpauseResponse} for more details.
      #
      ...
      #
      #   @param state [Symbol, Lithic::Models::ExternalBankAccountUnpauseResponse::State] Account State
      #
      #   @param type [Symbol, Lithic::Models::ExternalBankAccountUnpauseResponse::Type] Account Type
      #
      ...
      #
      #   @param verification_state [Symbol, Lithic::Models::ExternalBankAccountUnpauseResponse::VerificationState] Verification State
      #
      ...
      # Account State
      #
      # @see Lithic::Models::ExternalBankAccountUnpauseResponse#state
      module State
      ...
      # Account Type
      #
      # @see Lithic::Models::ExternalBankAccountUnpauseResponse#type
      module Type
        extend Lithic::Internal::Type::Enum
      ...
      # Verification State
      #
      # @see Lithic::Models::ExternalBankAccountUnpauseResponse#verification_state

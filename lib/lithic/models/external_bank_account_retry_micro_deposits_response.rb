...
module Lithic
  module Models
    ...
    class ExternalBankAccountRetryMicroDepositsResponse < Lithic::Internal::Type::BaseModel
      ...
      #   Owner Type
      #
      #   @return [Symbol, Lithic::Models::ExternalBankAccountRetryMicroDepositsResponse::OwnerType]
      required :owner_type,
      ...
      #   Account State
      #
      #   @return [Symbol, Lithic::Models::ExternalBankAccountRetryMicroDepositsResponse::State]
      required :state, enum: -> { Lithic::Models::ExternalBankAccountRetryMicroDepositsResponse::State }

      # @!attribute type
      #   Account Type
      #
      #   @return [Symbol, Lithic::Models::ExternalBankAccountRetryMicroDepositsResponse::Type]
      ...
      #   Verification Method
      #
      #   @return [Symbol, Lithic::Models::ExternalBankAccountRetryMicroDepositsResponse::VerificationMethod]
      ...
      #   Verification State
      #
      #   @return [Symbol, Lithic::Models::ExternalBankAccountRetryMicroDepositsResponse::VerificationState]

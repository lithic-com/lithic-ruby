...
module Lithic
  module Models
    ...
    class EventListAttemptsParams < Lithic::Internal::Type::BaseModel
      ...
      optional :status, enum: -> { Lithic::EventListAttemptsParams::Status }

      # @!method initialize(event_token:, begin_: nil, end_: nil, ending_before: nil, page_size: nil, starting_after: nil, status: nil, request_options: {})

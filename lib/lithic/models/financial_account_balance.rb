...
module Lithic
  module Models
    class FinancialAccountBalance < Lithic::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Lithic::Models::FinancialAccountBalance::Type]
      ...
      #   {Lithic::Models::FinancialAccountBalance} for more details.
      #
      ...
      #
      #   @param type [Symbol, Lithic::Models::FinancialAccountBalance::Type] Type of financial account.
      #
      #   @param updated [Time] Date and time for when the balance was last updated.

      # Type of financial account.
      #
      # @see Lithic::Models::FinancialAccountBalance#type
      module Type

...
module Lithic
  module Models
    ...
    class CardRenewResponse < Lithic::Internal::Type::BaseModel
      ...
      #
      #   @return [Lithic::Models::CardRenewResponse::Funding]
      required :funding, -> { Lithic::Models::CardRenewResponse::Funding }
      ...
      #   attempts).
      #
      #   @return [Symbol, Lithic::Models::CardRenewResponse::PinStatus]
      required :pin_status, enum: -> { Lithic::Models::CardRenewResponse::PinStatus }
      ...
      #
      #   @return [Symbol, Lithic::Models::CardRenewResponse::SpendLimitDuration]
      required :spend_limit_duration, enum: -> { Lithic::Models::CardRenewResponse::SpendLimitDuration }
      ...
      #   manufactured.
      #
      #   @return [Symbol, Lithic::Models::CardRenewResponse::State]
      required :state, enum: -> { Lithic::Models::CardRenewResponse::State }
      ...
      #   VIRTUAL instead.
      #
      #   @return [Symbol, Lithic::Models::CardRenewResponse::Type]
      required :type, enum: -> { Lithic::Models::CardRenewResponse::Type }
      ...
      #   @param created [Time]
      #   @param funding [Lithic::Models::CardRenewResponse::Funding]
      #   @param last_four [String]
      #   @param pin_status [Symbol, Lithic::Models::CardRenewResponse::PinStatus]
      #   @param spend_limit [Integer]
      #   @param spend_limit_duration [Symbol, Lithic::Models::CardRenewResponse::SpendLimitDuration]
      #   @param state [Symbol, Lithic::Models::CardRenewResponse::State]
      #   @param type [Symbol, Lithic::Models::CardRenewResponse::Type]
      ...
      # @see Lithic::Models::CardRenewResponse#funding
      class Funding < Lithic::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Lithic::Models::CardRenewResponse::Funding::State]
        required :state, enum: -> { Lithic::Models::CardRenewResponse::Funding::State }

        # @!attribute type
        #   Types of funding source: _ `DEPOSITORY_CHECKING` - Bank checking account. _
        #   `DEPOSITORY_SAVINGS` - Bank savings account.
        #
        #   @return [Symbol, Lithic::Models::CardRenewResponse::Funding::Type]
        required :type, enum: -> { Lithic::Models::CardRenewResponse::Funding::Type }
        ...
        #   @param created [Time]
        #   @param last_four [String]
        #   @param state [Symbol, Lithic::Models::CardRenewResponse::Funding::State]
        #   @param type [Symbol, Lithic::Models::CardRenewResponse::Funding::Type]
        ...
        # verification. \* `DELETED` - The founding account has been deleted.
        #
        # @see Lithic::Models::CardRenewResponse::Funding#state
        module State
        ...
        # `DEPOSITORY_SAVINGS` - Bank savings account.
        #
        # @see Lithic::Models::CardRenewResponse::Funding#type
        module Type
          extend Lithic::Internal::Type::Enum
      ...
      # attempts).
      #
      # @see Lithic::Models::CardRenewResponse#pin_status
      module PinStatus
        extend Lithic::Internal::Type::Enum
      ...
      # Spend limit duration
      #
      # @see Lithic::Models::CardRenewResponse#spend_limit_duration
      ...
      # manufactured.
      #
      # @see Lithic::Models::CardRenewResponse#state
      module State
        extend Lithic::Internal::Type::Enum
      ...
      # VIRTUAL instead.
      #
      # @see Lithic::Models::CardRenewResponse#type
      module Type
        extend Lithic::Internal::Type::Enum

...
module Lithic
  module Models
    ...
    class DisputeRetrieveResponse < Lithic::Internal::Type::BaseModel
      ...
      #     cancelled.
      #
      #   @return [Symbol, Lithic::Models::DisputeRetrieveResponse::Reason]
      required :reason, enum: -> { Lithic::Models::DisputeRetrieveResponse::Reason }
      ...
      #
      #   @return [Symbol, Lithic::Models::DisputeRetrieveResponse::ResolutionReason, nil]
      required :resolution_reason,
               enum: -> { Lithic::Models::DisputeRetrieveResponse::ResolutionReason },
               nil?: true
      ...
      #
      #   @return [Symbol, Lithic::Models::DisputeRetrieveResponse::Status]
      required :status, enum: -> { Lithic::Models::DisputeRetrieveResponse::Status }
      ...
      #   {Lithic::Models::DisputeRetrieveResponse} for more details.
      #
      #   Dispute.
      #
      ...
      #
      #   @param reason [Symbol, Lithic::Models::DisputeRetrieveResponse::Reason] Dispute reason:
      #
      ...
      #
      #   @param resolution_reason [Symbol, Lithic::Models::DisputeRetrieveResponse::ResolutionReason, nil] Reason for the dispute resolution:
      #
      #   @param status [Symbol, Lithic::Models::DisputeRetrieveResponse::Status] Status types:
      #
      ...
      #   cancelled.
      #
      # @see Lithic::Models::DisputeRetrieveResponse#reason
      module Reason
      ...
      # - `WON_PREARBITRATION`: Won prearbitration.
      #
      # @see Lithic::Models::DisputeRetrieveResponse#resolution_reason
      ...
      # - `CASE_CLOSED` - Case was lost or withdrawn.
      #
      # @see Lithic::Models::DisputeRetrieveResponse#status
      module Status
        extend Lithic::Internal::Type::Enum

...
module Lithic
  module Models
    module Events
      # @see Lithic::Resources::Events::Subscriptions#update
      class SubscriptionUpdateParams < Lithic::BaseModel
        ...
        optional :event_types,
                 -> { Lithic::ArrayOf[enum: Lithic::Models::Events::SubscriptionUpdateParams::EventType] }

        # @!parse
        #   # @return [Array<Symbol, Lithic::Models::Events::SubscriptionUpdateParams::EventType>]

...
module Lithic
  module Type
    ...
    module Union
      ...
      # @api private
      #
      # @param key [Symbol, Hash{Symbol=>Object}, Proc, Lithic::Type::Converter, Class]
      #
      # @param spec [Hash{Symbol=>Object}, Proc, Lithic::Type::Converter, Class] .
      #
      ...
      private def variant(key, spec = nil)
        variant_info =
          case key
          in Symbol
            [key, Lithic::Type::Converter.type_info(spec)]
          in Proc | Lithic::Type::Converter | Class | Hash
            [nil, Lithic::Type::Converter.type_info(key)]
          end
      ...
      # @param value [Object]
      #
      # @return [Lithic::Type::Converter, Class, nil]
      ...
      def coerce(value, state:)
        if (target = resolve_variant(value))
          return Lithic::Type::Converter.coerce(target, value, state: state)
        end
        ...
        known_variants.each do |_, variant_fn|
          ...
          coerced = Lithic::Type::Converter.coerce(target, value, state: state)
      ...
      def dump(value)
        if (target = resolve_variant(value))
          return Lithic::Type::Converter.dump(target, value)
        end

        known_variants.each do
          target = _2.call
          return Lithic::Type::Converter.dump(target, value) if target === value
        end

    ...
    module Converter
      ...
      class << self
        ...
        def type_info(spec)
          ...
          in true | false
            -> { Lithic::BooleanModel }
          in Lithic::Type::Converter | Class | Symbol
            -> { spec }
        ...
        #
        # @param target [Lithic::Type::Converter, Class]
        #
        # @param value [Object]
        #
        ...
        def dump(target, value)
          target.is_a?(Lithic::Type::Converter) ? target.dump(value) : Lithic::Unknown.dump(value)
        end
      end
    end

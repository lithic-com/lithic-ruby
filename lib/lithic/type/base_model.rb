  ...
  module Type
    ...
    class BaseModel
      ...
      class << self
        ...
        #
        # @param type_info [Hash{Symbol=>Object}, Proc, Lithic::Type::Converter, Class]
        #
        ...
        private def add_field(name_sym, required:, type_info:, spec:)
          type_fn, info =
            case type_info
            in Proc | Lithic::Type::Converter | Class
              [Lithic::Type::Converter.type_info({**spec, union: type_info}), spec]
            in Hash
              [Lithic::Type::Converter.type_info(type_info), type_info]
            end
          ...
          fields.each do |name, field|
            ...
            converted =
              if item.nil? && (nilable || !required)
                ...
                coerced = Lithic::Type::Converter.coerce(target, item, state: state)
                case target
                in Lithic::Type::Converter | Symbol
                  coerced
                else
                  item
                end
          ...
          coerced.each do |key, val|
            ...
            in nil
              ...
              in :coerce
                ...
                target = type_fn.call
                acc.store(api_name, Lithic::Type::Converter.dump(target, val))
              end
            end
          end

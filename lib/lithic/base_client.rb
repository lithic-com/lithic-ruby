...
module Lithic
  ...
  class BaseClient
    ...
    # @api private
    # @return [Lithic::PooledNetRequester]
    ...
    def initialize(
      ...
      @requester = Lithic::PooledNetRequester.new
    ...
    #
    #   @option req [Lithic::Converter, Class, nil] :model
    #
    ...
    def request(req)
      ...
      in { page: Class => page }
        ...
        Lithic::Converter.coerce(model, unwrapped)
      end
    end

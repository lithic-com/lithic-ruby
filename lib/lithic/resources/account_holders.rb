...
module Lithic
  module Resources
    class AccountHolders
      ...
      #     with the AUTHORIZED_USER in this field.
      #
      #   @option params [String] :email Account holder's email address. The primary purpose of this field is for
      #     cardholder identification and verification during the digital wallet
      #     tokenization process.
      #
      #   @option params [String] :phone_number Account holder's phone number, entered in E.164 format. The primary purpose of
      #     this field is for cardholder identification and verification during the digital
      #     wallet tokenization process.
      #
      #   @option params [Lithic::RequestOptions, Hash{Symbol=>Object}, nil] :request_options
      #
      # @return [Lithic::Models::AccountHolderUpdateResponse]

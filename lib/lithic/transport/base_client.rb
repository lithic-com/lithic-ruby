...
module Lithic
  module Transport
    ...
    class BaseClient
      ...
      PLATFORM_HEADERS =
        {
          "x-stainless-arch" => Lithic::Util.arch,
          "x-stainless-lang" => "ruby",
          "x-stainless-os" => Lithic::Util.os,
          "x-stainless-package-version" => Lithic::VERSION,
      ...
      class << self
        ...
        def should_retry?(status, headers:)
          coerced = Lithic::Util.coerce_boolean(headers["x-should-retry"])
          case [coerced, status]
          in [true | false, _]
            coerced
        ...
        def follow_redirect(request, status:, response_headers:)
          ...
          # from undici
          if Lithic::Util.uri_origin(url) != Lithic::Util.uri_origin(location)
      ...
      # @api private
      # @return [Lithic::Transport::PooledNetRequester]
      ...
      def initialize(
        ...
        @requester = Lithic::Transport::PooledNetRequester.new
        @headers = Lithic::Util.normalized_headers(
        ...
        @base_url = Lithic::Util.parse_uri(base_url)
      ...
      #
      #   @option req [Lithic::Type::Converter, Class, nil] :model
      #
      ...
      private def build_request(req, opts)
        ...
        path = Lithic::Util.interpolate_path(uninterpolated_path)

        query = Lithic::Util.deep_merge(req[:query].to_h, opts[:extra_query].to_h)
        ...
        body =
          ...
          in :get | :head | :options | :trace
            ...
            Lithic::Util.deep_merge(*[req[:body], opts[:extra_body]].compact)
          end

        headers, encoded = Lithic::Util.encode_content(headers, body)
        {
          method: method,
          url: Lithic::Util.join_parsed_uri(@base_url, {**req, path: path, query: query}),
          headers: headers,
          body: encoded,
      ...
      private def send_request(request, redirect_count:, retry_count:, send_retry_header:)
        ...
        input = {**request.except(:timeout), deadline: Lithic::Util.monotonic_secs + timeout}
        ...
        rescue Lithic::APIConnectionError => e
          status = e
        end
        ...
        in Lithic::APIConnectionError if retry_count >= max_retries
          raise status
        in (400..) if retry_count >= max_retries || !self.class.should_retry?(status, headers: response)
          decoded = Kernel.then do
            Lithic::Util.decode_content(response, stream: stream, suppress_error: true)
          ensure
            self.class.reap_connection!(status, stream: stream)
          end
      ...
      def request(req)
        ...
        model = req.fetch(:model) { Lithic::Unknown }
        ...
        decoded = Lithic::Util.decode_content(response, stream: stream)
        case req
        in { stream: Class => st }
        ...
        in { page: Class => page }
          ...
          unwrapped = Lithic::Util.dig(decoded, req[:unwrap])
          Lithic::Type::Converter.coerce(model, unwrapped)
        end
      end
      ...
      def inspect
        ...
        base_url = Lithic::Util.unparse_uri(@base_url)

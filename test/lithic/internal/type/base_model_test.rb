...
class Lithic::Test::PrimitiveModelTest < Minitest::Test
  ...
  def test_dump
    cases = {
      ...
      [String, Pathname(__FILE__)] => Lithic::FilePart
    }
...
class Lithic::Test::MetaInfoTest < Minitest::Test
  A1 = Lithic::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Lithic::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]

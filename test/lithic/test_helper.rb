...
class Lithic::Test::SingletonClient < Lithic::Client
  include Singleton

  def initialize
    super(base_url: ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010"), api_key: "My Lithic API Key")
  end
end
...
class Lithic::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @lithic = Lithic::Test::SingletonClient.instance
  end

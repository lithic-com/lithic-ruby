  ...
  def test_list
    ...
    assert_pattern do
      ...
      in {
        ...
        currency: String,
        descriptor: String,
        events: ^(Lithic::Internal::Type::ArrayOf[Lithic::Models::AccountActivityListResponse::Internal::Event]),
  ...
  def test_retrieve_transaction
    ...
    assert_pattern do
      ...
      in {
        ...
        currency: String,
        descriptor: String,
        events: ^(Lithic::Internal::Type::ArrayOf[Lithic::Models::AccountActivityRetrieveTransactionResponse::Internal::Event]),
        financial_account_token: String,
        pending_amount: Integer,

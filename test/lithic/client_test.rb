...
class LithicTest < Minitest::Test
  ...
  def test_client_default_request_default_retry_attempts
    stub_request(:post, "http://localhost/v1/cards").to_return_json(status: 500, body: {})

    lithic = Lithic::Client.new(base_url: "http://localhost", api_key: "My Lithic API Key")
  ...
  def test_client_given_request_default_retry_attempts
    ...
    lithic = Lithic::Client.new(base_url: "http://localhost", api_key: "My Lithic API Key", max_retries: 3)
  ...
  def test_client_redirect_307
    ...
    assert_requested(:any, "http://localhost/redirected", times: Lithic::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_303
    ...
    assert_requested(:get, "http://localhost/redirected", times: Lithic::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_auth_strip_cross_origin
    ...
    assert_requested(:any, "https://example.com/redirected", times: Lithic::Client::MAX_REDIRECTS) do
      headers = _1.headers.keys.map(&:downcase)
  ...
  def test_default_headers
    stub_request(:post, "http://localhost/v1/cards").to_return_json(status: 200, body: {})

  ...
  module Models
    class AccountHolderSimulateEnrollmentReviewResponse < Lithic::Internal::Type::BaseModel
      ...
      sig do
        params(
          status:
            Lithic::Models::AccountHolderSimulateEnrollmentReviewResponse::Status::OrSymbol
        ).void
      end
      attr_writer :status
      ...
      sig do
        params(
          status_reasons:
            T::Array[
              Lithic::Models::AccountHolderSimulateEnrollmentReviewResponse::StatusReason::OrSymbol
            ]
        ).void
      end
      ...
      sig do
        params(
          user_type:
            Lithic::Models::AccountHolderSimulateEnrollmentReviewResponse::UserType::OrSymbol
        ).void
      end
      ...
      sig do
        params(
          verification_application:
            Lithic::Models::AccountHolderSimulateEnrollmentReviewResponse::VerificationApplication::OrHash
        ).void
      end
      ...
      class BeneficialOwnerIndividual < Lithic::Internal::Type::BaseModel
        ...
        sig do
          params(
            address:
              Lithic::Models::AccountHolderSimulateEnrollmentReviewResponse::BeneficialOwnerIndividual::Address::OrHash
          ).void
        end
        attr_writer :address
      ...
      class ControlPerson < Lithic::Internal::Type::BaseModel
        ...
        sig do
          params(
            address:
              Lithic::Models::AccountHolderSimulateEnrollmentReviewResponse::ControlPerson::Address::OrHash
          ).void
        end
        attr_writer :address
      ...
      module ExemptionType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Lithic::Models::AccountHolderSimulateEnrollmentReviewResponse::ExemptionType
            )
          end
      ...
      class Individual < Lithic::Internal::Type::BaseModel
        ...
        sig do
          params(
            address:
              Lithic::Models::AccountHolderSimulateEnrollmentReviewResponse::Individual::Address::OrHash
          ).void
        end
        attr_writer :address
      ...
      module StatusReason
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Lithic::Models::AccountHolderSimulateEnrollmentReviewResponse::StatusReason
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module UserType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Lithic::Models::AccountHolderSimulateEnrollmentReviewResponse::UserType
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      class VerificationApplication < Lithic::Internal::Type::BaseModel
        ...
        sig do
          params(
            created: Time,
            status:
              Lithic::Models::AccountHolderSimulateEnrollmentReviewResponse::VerificationApplication::Status::OrSymbol,
            status_reasons:
              T::Array[
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Lithic::Models::AccountHolderSimulateEnrollmentReviewResponse::VerificationApplication::Status
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module StatusReason
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Lithic::Models::AccountHolderSimulateEnrollmentReviewResponse::VerificationApplication::StatusReason
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }

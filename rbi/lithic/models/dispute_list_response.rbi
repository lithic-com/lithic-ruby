...
module Lithic
  module Models
    class DisputeListResponse < Lithic::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Lithic::Models::DisputeListResponse, Lithic::Internal::AnyHash)
        end
      ...
      #   cancelled.
      sig { returns(Lithic::Models::DisputeListResponse::Reason::TaggedSymbol) }
      ...
      sig do
        returns(
          T.nilable(
            Lithic::Models::DisputeListResponse::ResolutionReason::TaggedSymbol
          )
        )
      end
      ...
      sig { returns(Lithic::Models::DisputeListResponse::Status::TaggedSymbol) }
      ...
      sig do
        params(
          ...
          reason: Lithic::Models::DisputeListResponse::Reason::OrSymbol,
          representment_date: T.nilable(Time),
          resolution_date: T.nilable(Time),
          resolution_note: T.nilable(String),
          resolution_reason:
            T.nilable(
              Lithic::Models::DisputeListResponse::ResolutionReason::OrSymbol
            ),
          status: Lithic::Models::DisputeListResponse::Status::OrSymbol,
        ...
        override.returns(
          {
            ...
            prearbitration_date: T.nilable(Time),
            primary_claim_id: T.nilable(String),
            reason: Lithic::Models::DisputeListResponse::Reason::TaggedSymbol,
            representment_date: T.nilable(Time),
            resolution_date: T.nilable(Time),
            resolution_note: T.nilable(String),
            resolution_reason:
            ...
            status: Lithic::Models::DisputeListResponse::Status::TaggedSymbol,
            transaction_token: String
          }
        )
      end
      ...
      module Reason
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Lithic::Models::DisputeListResponse::Reason)
          end
        ...
        ATM_CASH_MISDISPENSE =
          T.let(
            :ATM_CASH_MISDISPENSE,
            Lithic::Models::DisputeListResponse::Reason::TaggedSymbol
          )
        CANCELLED =
          T.let(
            :CANCELLED,
        ...
        sig do
          override.returns(
            T::Array[Lithic::Models::DisputeListResponse::Reason::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module ResolutionReason
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Lithic::Models::DisputeListResponse::ResolutionReason)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module Status
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Lithic::Models::DisputeListResponse::Status)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        ARBITRATION =
          T.let(
            :ARBITRATION,
            Lithic::Models::DisputeListResponse::Status::TaggedSymbol
          )
        CASE_CLOSED =
          T.let(
            :CASE_CLOSED,
        ...
        NEW =
          T.let(:NEW, Lithic::Models::DisputeListResponse::Status::TaggedSymbol)
        PENDING_CUSTOMER =
          T.let(
            :PENDING_CUSTOMER,
            Lithic::Models::DisputeListResponse::Status::TaggedSymbol
        ...
        sig do
          override.returns(
            T::Array[Lithic::Models::DisputeListResponse::Status::TaggedSymbol]
          )
        end
        def self.values
        end

            ...
            class MerchantLockParameters < Lithic::Internal::Type::BaseModel
              ...
              sig do
                params(
                  merchants:
                    T::Array[
                      Lithic::Models::AuthRules::V2CreateResponse::CurrentVersion::Parameters::MerchantLockParameters::Merchant::OrHash
                    ]
                ).returns(T.attached_class)
              end
              def self.new(
            ...
            class MerchantLockParameters < Lithic::Internal::Type::BaseModel
              ...
              sig do
                params(
                  merchants:
                    T::Array[
                      Lithic::Models::AuthRules::V2CreateResponse::DraftVersion::Parameters::MerchantLockParameters::Merchant::OrHash
                    ]
                ).returns(T.attached_class)
              end
              def self.new(

...
module Lithic
  module Models
    class DisputeCreateResponse < Lithic::Internal::Type::BaseModel
      ...
      #   cancelled.
      sig do
        returns(Lithic::Models::DisputeCreateResponse::Reason::TaggedSymbol)
      end
      ...
      sig do
        returns(
          T.nilable(
            Lithic::Models::DisputeCreateResponse::ResolutionReason::TaggedSymbol
          )
        )
      end
      ...
      sig do
        returns(Lithic::Models::DisputeCreateResponse::Status::TaggedSymbol)
      end
      ...
      sig do
        params(
          ...
          reason: Lithic::Models::DisputeCreateResponse::Reason::OrSymbol,
          representment_date: T.nilable(Time),
          resolution_date: T.nilable(Time),
          resolution_note: T.nilable(String),
          resolution_reason:
            T.nilable(
              Lithic::Models::DisputeCreateResponse::ResolutionReason::OrSymbol
            ),
          status: Lithic::Models::DisputeCreateResponse::Status::OrSymbol,
        ...
        override.returns(
          {
            ...
            prearbitration_date: T.nilable(Time),
            primary_claim_id: T.nilable(String),
            reason: Lithic::Models::DisputeCreateResponse::Reason::TaggedSymbol,
            representment_date: T.nilable(Time),
            resolution_date: T.nilable(Time),
            resolution_note: T.nilable(String),
            resolution_reason:
            ...
            status: Lithic::Models::DisputeCreateResponse::Status::TaggedSymbol,
            transaction_token: String
          }
        )
      end
      ...
      module Reason
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Lithic::Models::DisputeCreateResponse::Reason)
          end
        ...
        ATM_CASH_MISDISPENSE =
          T.let(
            :ATM_CASH_MISDISPENSE,
            Lithic::Models::DisputeCreateResponse::Reason::TaggedSymbol
          )
        CANCELLED =
          T.let(
            :CANCELLED,
      ...
      module ResolutionReason
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Lithic::Models::DisputeCreateResponse::ResolutionReason
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module Status
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Lithic::Models::DisputeCreateResponse::Status)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        ARBITRATION =
          T.let(
            :ARBITRATION,
            Lithic::Models::DisputeCreateResponse::Status::TaggedSymbol
          )
        CASE_CLOSED =
          T.let(
            :CASE_CLOSED,

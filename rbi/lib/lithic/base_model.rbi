...
module Lithic
  # @api private
  module Converter
    Input = T.type_alias { T.any(Lithic::Converter, T::Class[T.anything]) }
    ...
    # @api private
    sig { overridable.params(value: T.anything, state: Lithic::Converter::State).returns(T.anything) }
    ...
    class << self
          ...
          spec: T.any(
            {
              ...
              enum: T.nilable(T.proc.returns(Lithic::Converter::Input)),
              union: T.nilable(T.proc.returns(Lithic::Converter::Input))
            },
            T.proc.returns(Lithic::Converter::Input),
      ...
      sig do
        params(target: Lithic::Converter::Input, value: T.anything, state: Lithic::Converter::State)
          .returns(T.anything)
      end
      def self.coerce(
        target,
      ...
      # @api private
      sig { params(target: Lithic::Converter::Input, value: T.anything).returns(T.anything) }
  ...
  class Unknown
    ...
    class << self
      # @api private
      sig(:final) { override.params(value: T.anything, state: Lithic::Converter::State).returns(T.anything) }
      def coerce(value, state:)
      end
  ...
  class BooleanModel
    ...
    class << self
      ...
      sig(:final) do
        override
          .params(value: T.any(T::Boolean, T.anything), state: Lithic::Converter::State)
  ...
  module Enum
    ...
    sig do
      override
        .params(value: T.any(String, Symbol, T.anything), state: Lithic::Converter::State)
  ...
  module Union
    ...
    sig { returns(T::Array[[T.nilable(Symbol), T.proc.returns(Lithic::Converter::Input)]]) }
    ...
    sig do
      params(
        key: T.any(Symbol, Lithic::Util::AnyHash, T.proc.returns(T.anything), T.anything),
        spec: T.any(Lithic::Util::AnyHash, T.proc.returns(T.anything), T.anything)
      )
        .void
    end
    ...
    # @api private
    sig { override.params(value: T.anything, state: Lithic::Converter::State).returns(T.anything) }
    def coerce(value, state:)
    end
  ...
  class ArrayOf
    ...
    sig(:final) do
      override
        .params(value: T.any(T::Enumerable[T.anything], T.anything), state: Lithic::Converter::State)
  ...
  class HashOf
    ...
    sig(:final) do
      override
        .params(value: T.any(T::Hash[T.anything, T.anything], T.anything), state: Lithic::Converter::State)
  ...
  class BaseModel
    ...
    class << self
        ...
        returns(
          T::Hash[Symbol,
                  T.all(
                    ...
                    {type_fn: T.proc.returns(Lithic::Converter::Input)}
                  )]
        )
      end
      def known_fields
      ...
      # @api private
      sig do
        returns(T::Hash[Symbol, T.all(Lithic::BaseModel::KnownFieldShape, {type: Lithic::Converter::Input})])
      end
      def fields
      end
    ...
    sig { overridable.returns(Lithic::Util::AnyHash) }
    def to_h
    end
    ...
    sig { params(keys: T.nilable(T::Array[Symbol])).returns(Lithic::Util::AnyHash) }

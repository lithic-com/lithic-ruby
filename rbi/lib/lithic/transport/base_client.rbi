...
module Lithic
  module Transport
    ...
    class BaseClient
        ...
        T.type_alias do
          {
            ...
            page: T.nilable(T::Class[Lithic::Type::BasePage[Lithic::BaseModel]]),
            stream: T.nilable(T::Class[T.anything]),
            model: T.nilable(Lithic::Type::Converter::Input),
      ...
      class << self
        # @api private
        sig { params(req: Lithic::Transport::BaseClient::RequestComponentsShape).void }
        def validate!(req)
        end
        ...
        sig do
          params(
            request: Lithic::Transport::BaseClient::RequestInputShape,
            status: Integer,
            response_headers: T.any(T::Hash[String, String], Net::HTTPHeader)
          )
            .returns(Lithic::Transport::BaseClient::RequestInputShape)
        end
      ...
      # @api private
      sig { returns(Lithic::Transport::PooledNetRequester) }
      ...
      sig do
        overridable
          .params(req: Lithic::Transport::BaseClient::RequestComponentsShape, opts: Lithic::Util::AnyHash)
          .returns(Lithic::Transport::BaseClient::RequestInputShape)
      end

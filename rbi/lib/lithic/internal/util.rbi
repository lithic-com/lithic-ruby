...
module Lithic
  module Internal
    ...
    module Util
      ...
      #   structure when using `Lithic::Internal::Util.deep_merge`.
      #
      ...
      class << self
        ...
        sig do
          params(
            data: T.any(Lithic::Internal::Util::AnyHash, T::Array[T.anything], T.anything),
      ...
      class << self
        ...
        sig { params(lines: T::Enumerable[String]).returns(Lithic::Internal::Util::ServerSentEvent) }

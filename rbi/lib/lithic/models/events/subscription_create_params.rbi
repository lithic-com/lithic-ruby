  ...
  module Models
    module Events
      class SubscriptionCreateParams < Lithic::Internal::Type::BaseModel
        ...
        sig { params(event_types: T::Array[Lithic::Models::Events::SubscriptionCreateParams::EventType::OrSymbol]).void }
        ...
        module EventType
          ...
          OrSymbol =
            T.type_alias { T.any(Symbol, String, Lithic::Models::Events::SubscriptionCreateParams::EventType::TaggedSymbol) }

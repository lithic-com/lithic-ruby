  ...
  module Models
    module Cards
      class BalanceListResponse < Lithic::BaseModel
        ...
        sig { returns(Lithic::Models::Cards::BalanceListResponse::Type::TaggedSymbol) }
        def type
        end

        sig do
          params(_: Lithic::Models::Cards::BalanceListResponse::Type::TaggedSymbol)
            .returns(Lithic::Models::Cards::BalanceListResponse::Type::TaggedSymbol)
        end
        def type=(_)
        end
        ...
        module Type
          ...
          OrSymbol = T.type_alias { T.any(Symbol, Lithic::Models::Cards::BalanceListResponse::Type::TaggedSymbol) }

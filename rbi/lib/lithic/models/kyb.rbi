...
module Lithic
  module Models
    class KYB < Lithic::BaseModel
      ...
      sig { params(_: Lithic::Models::KYB::BusinessEntity).returns(Lithic::Models::KYB::BusinessEntity) }
      ...
      sig { params(_: Lithic::Models::KYB::ControlPerson).returns(Lithic::Models::KYB::ControlPerson) }

    ...
    module AuthRules
      class V2ApplyResponse < Lithic::BaseModel
        ...
        sig do
          params(
            current_version: T.nilable(
              T.any(Lithic::Models::AuthRules::V2ApplyResponse::CurrentVersion, Lithic::Internal::Util::AnyHash)
            )
          )
            .void
        end
        ...
        sig do
          params(
            draft_version: T.nilable(
              T.any(Lithic::Models::AuthRules::V2ApplyResponse::DraftVersion, Lithic::Internal::Util::AnyHash)
            )
          )
            .void
        end
        ...
        module State
          ...
          OrSymbol =
            T.type_alias { T.any(Symbol, String, Lithic::Models::AuthRules::V2ApplyResponse::State::TaggedSymbol) }
        ...
        module Type
          ...
          OrSymbol =
            T.type_alias { T.any(Symbol, String, Lithic::Models::AuthRules::V2ApplyResponse::Type::TaggedSymbol) }

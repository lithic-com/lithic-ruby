  ...
  module Models
    module AuthRules
      class V2UpdateResponse < Lithic::BaseModel
        ...
        sig do
          params(
            _: T.nilable(T.any(Lithic::Models::AuthRules::V2UpdateResponse::CurrentVersion, Lithic::Util::AnyHash))
          )
            .returns(
              T.nilable(T.any(Lithic::Models::AuthRules::V2UpdateResponse::CurrentVersion, Lithic::Util::AnyHash))
            )
        end
        ...
        sig do
          params(
            _: T.nilable(T.any(Lithic::Models::AuthRules::V2UpdateResponse::DraftVersion, Lithic::Util::AnyHash))
          )
            .returns(
              T.nilable(T.any(Lithic::Models::AuthRules::V2UpdateResponse::DraftVersion, Lithic::Util::AnyHash))
            )
        end
        def draft_version=(_)
        end
        ...
        sig do
          params(_: Lithic::Models::AuthRules::V2UpdateResponse::State::TaggedSymbol)
            .returns(Lithic::Models::AuthRules::V2UpdateResponse::State::TaggedSymbol)
        end
        def state=(_)
        end
        ...
        sig do
          params(_: Lithic::Models::AuthRules::V2UpdateResponse::Type::TaggedSymbol)
            .returns(Lithic::Models::AuthRules::V2UpdateResponse::Type::TaggedSymbol)
        end
        def type=(_)
        end

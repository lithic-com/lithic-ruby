    ...
    module AuthRules
      class V2UpdateResponse < Lithic::BaseModel
        ...
        sig do
          params(
            current_version: T.nilable(
              T.any(Lithic::Models::AuthRules::V2UpdateResponse::CurrentVersion, Lithic::Internal::Util::AnyHash)
            )
          )
            .void
        end
        ...
        sig do
          params(
            draft_version: T.nilable(
              T.any(Lithic::Models::AuthRules::V2UpdateResponse::DraftVersion, Lithic::Internal::Util::AnyHash)
            )
          )
            .void
        end
        ...
        module State
          ...
          OrSymbol =
            T.type_alias { T.any(Symbol, String, Lithic::Models::AuthRules::V2UpdateResponse::State::TaggedSymbol) }
        ...
        module Type
          ...
          OrSymbol =
            T.type_alias { T.any(Symbol, String, Lithic::Models::AuthRules::V2UpdateResponse::Type::TaggedSymbol) }

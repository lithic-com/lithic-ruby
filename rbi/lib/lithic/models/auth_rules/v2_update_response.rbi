  ...
  module Models
    module AuthRules
      class V2UpdateResponse < Lithic::BaseModel
        ...
        sig do
          params(_: T.nilable(Lithic::Models::AuthRules::V2UpdateResponse::CurrentVersion))
            .returns(T.nilable(Lithic::Models::AuthRules::V2UpdateResponse::CurrentVersion))
        end
        ...
        sig do
          params(_: T.nilable(Lithic::Models::AuthRules::V2UpdateResponse::DraftVersion))
            .returns(T.nilable(Lithic::Models::AuthRules::V2UpdateResponse::DraftVersion))
        end
        def draft_version=(_)
        end

        ...
        sig do
          params(
            current_version: T.nilable(
              T.any(Lithic::Models::AuthRules::V2CreateResponse::CurrentVersion, Lithic::Internal::Util::AnyHash)
            )
          )
            .void
        end
        ...
        sig do
          params(
            draft_version: T.nilable(
              T.any(Lithic::Models::AuthRules::V2CreateResponse::DraftVersion, Lithic::Internal::Util::AnyHash)
            )
          )
            .void
        end

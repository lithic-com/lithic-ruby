...
module Lithic
  module Models
    class ExternalBankAccountRetryPrenoteResponse < Lithic::BaseModel
      ...
      sig { params(_: Lithic::Models::OwnerType::TaggedSymbol).returns(Lithic::Models::OwnerType::TaggedSymbol) }
      def owner_type=(_)
      end
      ...
      sig do
        params(_: Lithic::Models::ExternalBankAccountRetryPrenoteResponse::State::TaggedSymbol)
          .returns(Lithic::Models::ExternalBankAccountRetryPrenoteResponse::State::TaggedSymbol)
      end
      def state=(_)
      end
      ...
      sig do
        params(_: Lithic::Models::ExternalBankAccountRetryPrenoteResponse::Type::TaggedSymbol)
          .returns(Lithic::Models::ExternalBankAccountRetryPrenoteResponse::Type::TaggedSymbol)
      end
      def type=(_)
      end
      ...
      sig do
        params(_: Lithic::Models::VerificationMethod::TaggedSymbol)
          .returns(Lithic::Models::VerificationMethod::TaggedSymbol)
      end
      ...
      sig do
        params(_: Lithic::Models::ExternalBankAccountRetryPrenoteResponse::VerificationState::TaggedSymbol)
          .returns(Lithic::Models::ExternalBankAccountRetryPrenoteResponse::VerificationState::TaggedSymbol)
      end

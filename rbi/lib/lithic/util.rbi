...
module Lithic
  ...
  module Util
    ...
    #   structure when using `Lithic::Util.deep_merge`.
    #
    ...
    class << self
      ...
      sig do
        params(
          data: T.any(Lithic::Util::AnyHash, T::Array[T.anything], T.anything),
    ...
    class << self
      # @api private
      sig { params(url: T.any(URI::Generic, String)).returns(Lithic::Util::ParsedUriShape) }
      def parse_uri(url)
      end

      # @api private
      sig { params(parsed: Lithic::Util::ParsedUriShape).returns(URI::Generic) }
      def unparse_uri(parsed)
      end

      # @api private
      sig do
        params(lhs: Lithic::Util::ParsedUriShape, rhs: Lithic::Util::ParsedUriShape).returns(URI::Generic)
      end
    ...
    class << self
      ...
      sig { params(lines: T::Enumerable[String]).returns(Lithic::Util::ServerSentEvent) }

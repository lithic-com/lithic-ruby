...
module Lithic
  ...
  module RequestParameters
    ...
    sig do
      params(_: T.any(Lithic::RequestOptions, Lithic::Util::AnyHash))
        .returns(T.any(Lithic::RequestOptions, Lithic::Util::AnyHash))
    end
  ...
  class RequestOptions < Lithic::BaseModel
    ...
    sig { params(values: Lithic::Util::AnyHash).returns(T.attached_class) }
    def self.new(values = {})
    end
  end
end

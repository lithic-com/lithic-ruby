...
module Lithic
  ...
  module RequestParameters
    ...
    sig { returns(T.any(Lithic::RequestOptions, T::Hash[Symbol, T.anything])) }
    def request_options
    end

    sig do
      params(_: T.any(Lithic::RequestOptions, T::Hash[Symbol, T.anything]))
        .returns(T.any(Lithic::RequestOptions, T::Hash[Symbol, T.anything]))
    end

...
module Lithic
  module Type
    # @api private
    module Converter
      Input = T.type_alias { T.any(Lithic::Type::Converter, T::Class[T.anything]) }
      ...
      # @api private
      sig { overridable.params(value: T.anything, state: Lithic::Type::Converter::State).returns(T.anything) }
      ...
      class << self
            ...
            spec: T.any(
              {
                ...
                enum: T.nilable(T.proc.returns(Lithic::Type::Converter::Input)),
                union: T.nilable(T.proc.returns(Lithic::Type::Converter::Input))
              },
        ...
        sig do
          params(
            target: Lithic::Type::Converter::Input,
            value: T.anything,
        ...
        # @api private
        sig { params(target: Lithic::Type::Converter::Input, value: T.anything).returns(T.anything) }
